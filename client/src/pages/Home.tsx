...
export default function Home() {
  ...
  // A/B Test headlines - rotate randomly
  const headlines = [
    {
      title: "Find Profitable Expired Domains Before Your Competition",
      subtitle: "Upload any SpamZilla screenshot. Our AI analyzes 15+ SEO metrics, ranks the top 5 opportunities, and gives you a due diligence checklist - in 60 seconds."
    },
    {
      title: "Turn 3 Hours of Domain Research Into 60 Seconds",
      subtitle: "Stop manually checking Trust Flow, Citation Flow, and backlink quality. Our AI analyzes 15+ metrics and ranks the best opportunities automatically."
    },
    {
      title: "The AI Domain Analyst That Never Misses a Hidden Gem",
      subtitle: "Upload a SpamZilla screenshot. Get the top 5 ranked domains with AI explanations, Sherlock Check, and due diligence checklist."
    }
  ];
      ...
      <section className="relative px-6 py-20 lg:py-28 overflow-hidden bg-gradient-to-br from-indigo-50 via-white to-purple-50">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto mb-10 leading-relaxed">
            Browse <strong>hundreds of expired domains</strong> updated hourly. Filter by Trust Flow, niche, price, and availability. 
            Find hidden gems with backlinks and authority — <span className="text-indigo-600 font-bold">no screenshots needed</span>.
          </p>
